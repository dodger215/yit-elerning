  ...
  <AppLayout>
    ...
    <div class="max-w-5xl mx-auto py-8 px-4">
      ...
      <div class="mb-8 text-center">
        ...
        <p class="text-slate-400">Build powerful forms with our drag & drop builder</p>
      </div>
      ...
      <div class="flex justify-end">
        ...
        >
          ...
          {{ form.processing ? 'Creating Form...' : 'Publish Form' }}
        </button>
      </div>
    </div>
  </AppLayout>
